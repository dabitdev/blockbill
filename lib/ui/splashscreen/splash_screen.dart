...
class _SplashScreenState extends State<SplashScreenPage> {
  ...
  final blockBill = new RichText(
    text: new TextSpan(
      children: <TextSpan>[
        new TextSpan(
            text: 'BLOCK', style: new TextStyle(color: Colors.black, fontSize: 35)),
        new TextSpan(text: 'BILL', style: new TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 35)),
      ],
    ),
  );
          ...
          builder: (BuildContext context) {
            ...
            children: <Widget>[
              Container(
                height: 100,
                width: 100,
                child: Image.asset('assets/plane.png', fit: BoxFit.cover,),
              ),
              blockBill,
              FutureBuilder(
                future: getAccountId(),
  ...
  void setAccountId(String accountId) async {
    ...
    try{
      ...
      await localStorage.write('account_id', accountId);
      Navigator.push(
          context,
